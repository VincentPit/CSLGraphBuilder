"""
Transformer - Migrated from graphTransformer.py
...
Original File: graphTransformer.py
New Location: src/graphbuilder/core/graph/transformer.py
"""
...
class LLMGraphTransformer:
    ...
    async def t_to_graph_documentsaconver(
        self, documents: Sequence[Document]
    ) -> List[GraphDocument]:
        """
